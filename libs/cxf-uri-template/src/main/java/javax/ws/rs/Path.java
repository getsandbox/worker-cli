 ...
 *
 * <p>Classes and methods may also be annotated with Consumes and
 * Produces to filter the requests they will receive.</p>
 *
 * @author Paul Sandoz
 * @author Marc Hadley
 * @since 1.0
...
public @interface Path {
     ...
     *
     * <p>See < href="http://tools.ietf.org/html/rfc5234">RFC 5234</a>}
     ...
     * the rules of
     * < href="http://tools.ietf.org/html/rfc3986#section-3.3">RFC 3986 section 3.3</a>}.
