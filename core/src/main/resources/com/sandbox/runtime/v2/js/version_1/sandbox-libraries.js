(function(global){
    ...
    const libraryVersion = "version_1"
    global.faker = getLibraryObject(libraryVersion, "faker-2.1.2.min.js", "faker");
    global._ = getLibraryObject(libraryVersion, "lodash-2.4.1.min.js", "_");
    global.moment = getLibraryObject(libraryVersion, "moment-2.8.2.min.js", "moment");

    global.validator = evalLibrary(libraryVersion, "validator.min.js", "validator");
